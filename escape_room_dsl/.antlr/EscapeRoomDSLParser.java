...
public class EscapeRoomDSLParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, T__26=27, T__27=28, T__28=29, PLAYER_CLASS=30, BOOLEAN=31, 
		ID=32, STRING=33, MULTILINE_STRING=34, FLOAT=35, INT=36, WS=37, COMMENT=38;
	public static final int
		RULE_start = 0, RULE_escape_room = 1, RULE_metadata = 2, RULE_metadata_property = 3, 
		RULE_title_property = 4, RULE_description_property = 5, RULE_max_time_property = 6, 
		RULE_fog_of_war_property = 7, RULE_view_distance_property = 8, RULE_camera_zoom_property = 9, 
		RULE_rooms = 10, RULE_room = 11, RULE_room_property = 12, RULE_room_description_property = 13, 
		RULE_room_x_property = 14, RULE_room_y_property = 15, RULE_room_width_property = 16, 
		RULE_room_height_property = 17, RULE_room_pattern_property = 18, RULE_room_connections_property = 19, 
		RULE_player = 20, RULE_player_property = 21, RULE_player_class_property = 22, 
		RULE_player_start_x_property = 23, RULE_player_start_y_property = 24, 
		RULE_player_health_property = 25, RULE_player_mana_property = 26, RULE_player_stamina_property = 27, 
		RULE_player_speed_property = 28, RULE_player_mana_restore_property = 29, 
		RULE_player_stamina_restore_property = 30, RULE_array = 31, RULE_value = 32, 
		RULE_multiline_string = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			"start", "escape_room", "metadata", "metadata_property", "title_property", 
			"description_property", "max_time_property", "fog_of_war_property", "view_distance_property", 
			"camera_zoom_property", "rooms", "room", "room_property", "room_description_property", 
			"room_x_property", "room_y_property", "room_width_property", "room_height_property", 
			"room_pattern_property", "room_connections_property", "player", "player_property", 
			"player_class_property", "player_start_x_property", "player_start_y_property", 
			"player_health_property", "player_mana_property", "player_stamina_property", 
			"player_speed_property", "player_mana_restore_property", "player_stamina_restore_property", 
			"array", "value", "multiline_string"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'max_time:'", "'fog_of_war:'", "'view_distance:'", "'camera_zoom:'", 
			"'rooms:'", "':'", "'x:'", "'y:'", "'width:'", "'height:'", "'pattern:'", 
			"'connections:'", "'player:'", "'class:'", "'start_x:'", "'start_y:'", 
			"'health:'", "'mana:'", "'stamina:'", "'speed:'", "'mana_restore:'", 
			"'stamina_restore:'", "'['", "','", "']'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "PLAYER_CLASS", "BOOLEAN", "ID", 
			"STRING", "MULTILINE_STRING", "FLOAT", "INT", "WS", "COMMENT"
		};
	}
	...
	public final Max_time_propertyContext max_time_property() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_max_time_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(97);
	...
	public final Fog_of_war_propertyContext fog_of_war_property() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_fog_of_war_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(100);
	...
	public final View_distance_propertyContext view_distance_property() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_view_distance_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(103);
	...
	public final Camera_zoom_propertyContext camera_zoom_property() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_camera_zoom_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(106);
	...
	public final RoomsContext rooms() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_rooms);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RoomContext room() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_room);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 129040L) != 0)) {
				{
				{
				setState(117);
				room_property();
	...
	public final Room_propertyContext room_property() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_room_property);
		try {
			setState(130);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Room_description_propertyContext room_description_property() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_room_description_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(132);
	...
	public final Room_x_propertyContext room_x_property() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_room_x_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(135);
	...
	public final Room_y_propertyContext room_y_property() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_room_y_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(138);
	...
	public final Room_width_propertyContext room_width_property() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_room_width_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(141);
	...
	public final Room_height_propertyContext room_height_property() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_room_height_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(144);
	...
	public final Room_pattern_propertyContext room_pattern_property() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_room_pattern_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(147);
	...
	public final Room_connections_propertyContext room_connections_property() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_room_connections_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(150);
	...
	public final PlayerContext player() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_player);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 133955584L) != 0)) {
				{
				{
				setState(154);
				player_property();
	...
	public final Player_propertyContext player_property() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_player_property);
		try {
			setState(169);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Player_class_propertyContext player_class_property() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_player_class_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(171);
	...
	public final Player_start_x_propertyContext player_start_x_property() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_player_start_x_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(174);
	...
	public final Player_start_y_propertyContext player_start_y_property() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_player_start_y_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(177);
	...
	public final Player_health_propertyContext player_health_property() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_player_health_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(180);
	...
	public final Player_mana_propertyContext player_mana_property() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_player_mana_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(183);
	...
	public final Player_stamina_propertyContext player_stamina_property() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_player_stamina_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(186);
	...
	public final Player_speed_propertyContext player_speed_property() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_player_speed_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(189);
	...
	public final Player_mana_restore_propertyContext player_mana_restore_property() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_player_mana_restore_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(192);
	...
	public final Player_stamina_restore_propertyContext player_stamina_restore_property() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_player_stamina_restore_property);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(195);
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 118245818368L) != 0)) {
				{
				setState(199);
				value();
				setState(204);
	...
	public final Multiline_stringContext multiline_string() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_multiline_string);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(219);
