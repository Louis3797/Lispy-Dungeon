 ...
 *
 * <p>
 * Provides convenient methods to spawn chests, NPCs, and other entities that
 * trigger quizzes
...
public class QuizEntityFactory {
   ...
   * @param onFailure Callback when quiz is answered incorrectly (can be null)
   * @return The chest entity
   */
  public static Entity createQuizChest(
      Point position, Quiz quiz, String reward, Runnable onSuccess, Runnable onFailure) {
    try {
  ...
  public static Entity createQuizChest(Point position, Quiz quiz, String reward) {
    return createQuizChest(position, quiz, reward, null, null);
  }
   ...
   */
  public static Entity createQuizNPC(
      Point position, String texturePath, Quiz quiz, String reward, Runnable onSuccess, Runnable onFailure) {
  ...
  public static Entity createQuizNPC(Point position, Quiz quiz, String reward) {
    return createQuizNPC(position, DEFAULT_NPC_TEXTURE, quiz, reward, null, null);
  }
}
