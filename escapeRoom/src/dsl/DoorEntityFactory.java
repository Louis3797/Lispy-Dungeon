...
public class DoorEntityFactory {
   ...
   */
  public static Entity createLockedDoorIndicator(
      DoorTile door,
    ...
    doorEntity.add(
        new InteractionComponent(
            ...
            (entity, hero) -> {
              if (door.isOpen()) {
                DialogUtils.showTextPopup("The door is now open!", "Door");
              } else {
                ...
                if (hasKey) {
                  ...
                  DialogUtils.showTextPopup(
                      "🔓 You unlocked the door with your " + requiredItemId + "!", "Success");
                } else {
                  DialogUtils.showTextPopup(
   ...
   */
  public static Entity createUnlockedDoorIndicator(
      DoorTile door, Point position, String direction) {
    ...
    doorEntity.add(
        new InteractionComponent(
            ...
            true,
            (entity, hero) -> {
              DialogUtils.showTextPopup("This door connects to another room.", "Door");
            }));
