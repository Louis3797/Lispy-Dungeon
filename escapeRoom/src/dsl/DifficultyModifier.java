...
/**
 * Handles difficulty scaling for escape rooms.
 * Modifies monster stats and player stats based on difficulty setting.
 */
public class DifficultyModifier {
    ...
    public enum Difficulty {
        ...
        /**
         * Parse difficulty string to enum, case-insensitive.
         * Returns NORMAL if string is invalid.
         */
    ...
    public DifficultyModifier(String difficultyStr) {
        ...
        LOGGER.info("Difficulty set to: " + difficulty + " (monsters: " +
                (difficulty.monsterMultiplier * 100) + "%, player: " +
