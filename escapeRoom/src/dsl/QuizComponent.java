 ...
 * 
 * <p>
 * Entities with this component can trigger a quiz when interacted with.
 * The quiz is created from DSL definitions and displayed using the game's UI
 * system.
 */
public class QuizComponent implements Component {
     ...
     * @param reward The reward identifier to give on successful completion (can be
     *               null)
     */
