 ...
 *
 * <p>Provides methods for: - Finding random floor positions - Getting positions within specific
 * areas - Calculating distances between points
 */
public final class PositionUtils {
  ...
  public static Point getRandomFloorPosition() {
    ...
    List<Tile> floorTiles = level.floorTiles().stream().map(tile -> (Tile) tile).toList();
