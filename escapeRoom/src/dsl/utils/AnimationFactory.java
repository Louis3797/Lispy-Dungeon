 ...
 *
 * <p>Provides methods for: - Loading animation spritesheets with error handling - Creating
 * single-frame animations - Fallback to default textures on failure
 */
public final class AnimationFactory {
   ...
   */
  public static Map<String, Animation> loadSpritesheetWithFallback(
      String texturePath, String fallbackPath) {
    Objects.requireNonNull(texturePath, "texturePath cannot be null");
   ...
   * @throws NullPointerException if texturePath or fallbackPath is null
   */
  public static Animation createSingleFrameAnimationWithFallback(
      String texturePath, String fallbackPath) {
    Objects.requireNonNull(texturePath, "texturePath cannot be null");
    Objects.requireNonNull(fallbackPath, "fallbackPath cannot be null");
  ...
  /**
   * Gets the default idle animation from a loaded spritesheet. Tries "idle_down", then "idle", then
