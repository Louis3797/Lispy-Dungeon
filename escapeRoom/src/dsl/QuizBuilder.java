 ...
 *
 * <p>Provides a convenient way to create quizzes without dealing with the complexity of the
 * Task/Quiz system directly.
 */
public class QuizBuilder {
   ...
   * @return The configured Quiz
   */
  public static Quiz createMultipleChoice(
      String question, List<String> answers, List<Integer> correctIndices) {
    return new QuizBuilder()
        .question(question)
